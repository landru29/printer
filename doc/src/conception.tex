...
\begin{figure}%
   ...
   \center{\includegraphics[width=10cm]{img/heater_sch.jpg}}%
\end{figure}%
...
\begin{figure}%
   ...
   \center{\includegraphics[width=10cm]{img/radiateur01.jpg}}%
\end{figure}%
...
\begin{figure}%
   ...
   \center{\includegraphics[width=10cm]{img/buse.jpg}}%
\end{figure}%